...
session_start();
    ...
    $buildingid = $_GET["id"];
    $query6 = "SELECT * from buildings where building_id = $buildingid";
    ...
    $edbuildingid = $_GET["id"];
    $query9 = "SELECT * from buildings where building_id = $edbuildingid";
        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <?php while ($row9 = $res9->fetch_assoc()){
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title"><?php echo $row9["building_name"]; ?>
                                        <a href="building_edit_form.php?id=<?php echo $row9["building_id"];?>" class="btn btn-success btn-sm ms-3">Edit</a>
                                        <form method="post" action="includes/delete_building_process.php">
                                            <input type="hidden" name="del_building" value="<?php echo $row6["building_id"];?>">
                                            <input type="hidden" name="del_building_owner" value="<?php echo $row6["owner_id"];?>">
                                            <button class="btn btn-success btn-sm ms-3" type="submit" value="bdelete" name="delete_building">Delete</button> 
                                        </form>
