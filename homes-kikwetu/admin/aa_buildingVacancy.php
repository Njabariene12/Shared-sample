                                            ...
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#11111</a> </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="d-flex align-items-center">
                                                                    
                                                                    <div class="flex-grow-1 ms-2"><h5 class="my-0">1st</h5></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>2-Bedroom</td>
                                                        <td>
                                                            <h5 class="my-0">Kes.30,000</h5>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 ms-2"><h5 class="my-0">2nd</h5></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>1-Bedroom</td>
                                                        <td>
                                                            <h5 class="my-0">Kes.20,000</h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#333</a> </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="d-flex align-items-center">
                                                                    
                                                                    <div class="flex-grow-1 ms-2"><h5 class="my-0">3rd</h5></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>Studio</td>
                                                        <td>
                                                            <h5 class="my-0">Kes.15,000</h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#4444</a> </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="d-flex align-items-center">
                                                                    
                                                                    <div class="flex-grow-1 ms-2"><h5 class="my-0">4th</h5></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>Stall</td>
                                                        <td>
                                                            <h5 class="my-0">Kes.10,000</h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#11222</a> </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">#2334</a> </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="d-flex align-items-center">
