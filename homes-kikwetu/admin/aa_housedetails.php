...
session_start();
    ...
    /*ONLY FOR DELETE PURPOSES*/
    $hs_houseid = $_GET["id"];
    $query21 = "SELECT * from houses where house_id = $hs_houseid";
    $res21 = mysqli_query($conn, $query21);
    $row21 = mysqli_fetch_assoc($res21);

    /*inserting house details such as house number and status*/

    /*EDITING THE HOUSE*/ 
    $edhouseid = $_GET["id"];
    $query22 = "SELECT * from houses where house_id = $edhouseid";
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">
                                        ...
                                        <form method="post" action="includes/delete_house_process.php">
                                            <input type="hidden" name="del_hse" value="<?php echo $row21["house_id"];?>">
                                            <input type="hidden" name="del_build_hse" value="<?php echo $row21["building_id"];?>">
                                            <button class="btn btn-success btn-sm ms-3" type="submit" value="delete" name="delete_house">Delete</button>                                           
                                        </form>                                        
                                    </h4>
                        ...
                        <?php while($row20 = $res22->fetch_assoc()){
                       
                        ?>

                        <a href="house_edit_form.php?id=<?php echo $row20["house_id"];?>" class="btn btn-success btn-sm ms-3">Edit</a>
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="TaskDetailModalLabel">Summary</h4>
                                <p> <?php echo $row20["house_number"];?></p>
                                ...
                                <div class="board">
                                    <div class="tasks" data-plugin="dragula" data-containers='["task-list-one", "task-list-two", "task-list-three", "task-list-four"]'>                   
                                        <div id="task-list-one" class="task-list-items">
                                            ...
                                            <!-- Task Item -->
                                            <div class="card mb-0">
                                                <img src="assets/images/users/street1.jpeg" alt="" class="images">
                                            </div>
                                    ...
                                    <div class="tasks">
                                       <div id="task-list-two" class="task-list-items">
                                            ...
                                            <!-- Task Item -->
                                            <div class="card mb-0">                 
                                                <img src="assets/images/users/street 3.webp" alt="" class="images">                
                                            </div>
                                            <!-- Task Item End -->
                                    ...
                                    <div class="tasks">
                                        ...
                                        <div id="task-list-four" class="task-list-items">
                                            ...
                                            <!-- Task Item -->
                                            <div class="card mb-0">
                                                <img src="assets/images/users/livingroompic4.png" alt="" class="images"> <!-- end card-body -->
                                            </div>
                                            <!-- Task Item End -->
