                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Tenants
                                        <a href="tenant_form.php" class="btn btn-success btn-sm ms-3">Add New</a></h4>
                                </div>
                            </div>
                        </div> 
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <?php while($row14 = $res14->fetch_assoc()){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold"> <?php $row14["phone_number"];?> </a> </td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 ms-2"><h5 class="my-0"> <?php $row14["tenant_name"] ?> </h5></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>Landing Page</td>
                                                        ...
                                                        <td> <?php $row14["date_moved"] ?> </td>
                                                        <td><h5 class="my-0"><span class="badge badge-info-lighten">Paid</span></h5></td>
                                                        <td>
                                                            <a href="aa_tenant_analyisis.php?id=<?php $row14["tenant_id"] ?>" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
